/** @ts-expect-error
  a lot of unused variables for now
*/
...
export default function ImageTrail({
  ...
  return (
    <div
      className="w-full h-full relative z-[100] rounded-none bg-transparent overflow-visible"
      ref={containerRef}
    >
      {items.map((url, i) => (
        <div
          className="content__img w-[250px] aspect-[1.6] rounded-none absolute top-0 left-0 opacity-0 overflow-hidden [will-change:transform,filter]"
          key={i}
        >
          <div
